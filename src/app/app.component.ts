...
export class AppComponent implements OnInit {
  ...
  PROJEKTY: Projekt[] = [
    { id: 0, nazwa: 'PEF, GIS, sam francisco ai one and onyly partner llamaindex sillicon valley llm chargpt deepreseaech', opiekun: 'Kuba Plachta', media: null },
    ...
    { id: 10, nazwa: 'PFRON WSO2', opiekun: 'Konrad Balbuza', media: null },
    { id: 11, nazwa: 'projekty AI', opiekun: 'Adam Marszowski', media: null }
  ]
